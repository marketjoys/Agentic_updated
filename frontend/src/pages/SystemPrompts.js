              ...
              <textarea
                ...
                onKeyDown={(e) => {
                  ...
                  if (e.key === 'Escape') {
                    ...
                    if (e.target !== document.activeElement || !formData.prompt_text.trim()) {
                      onClose();
                    }
                  }
                }}
                rows={12}
                className="w-full px-3 py-2 border rounded-md font-mono text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-vertical"
                required
